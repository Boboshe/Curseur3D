...
public class Curseur3d {
    ...
    public Curseur3d(boolean tourne) {
        ...
        String path1 = this.getClass().getResource("../ressource/hand1.obj").getPath();
        path1 = path1.substring(1);

        try {
            s1 = loader.load(path1);
        ...
        Scene s2 = null;
        String path2 = this.getClass().getResource("../ressource/hand3.obj").getPath();
        path2 = path2.substring(1);

        try {
            s2 = loader.load(path2);
        } catch (FileNotFoundException e) {
            System.err.println(e);
            System.exit(1);
        } catch (ParsingErrorException e) {
     ...
     */
    public TransformGroup getNoeudRacine() {
    ...
    public void initialise() {
        this.tgPosition.setTransform(new Transform3D());
    }
