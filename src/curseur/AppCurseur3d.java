...
public class AppCurseur3d extends JFrame {
    ...
    private ArrayList<Primitive> shapes = new ArrayList();

    public ArrayList<Primitive> getShapes() {
        return shapes;
    }

    public void setShapes(ArrayList<Primitive> shapes) {
        this.shapes = shapes;
    }
    
    //Test pour rendre générique
//    private Hashtable<Primitive,String> sh = new Hashtable();
    ...
    public AppCurseur3d(int l,
        ...
        /*----- Ajout du listener au canevas -----*/
        this.curseurKeyListener = new CurseurKeyListener();
        canvas.addKeyListener(curseurKeyListener);
...
//        sh.put(cyl, "cylindre");
        ...
        /* ----- --------------------------- ----- */
        /* ----- Mon comportement du curseur ----- */
        /* ----- --------------------------- ----- */
        CursorBehavior cursorBehavior = new CursorBehavior(this.curseur, this.curseurKeyListener);
        racine.addChild(cursorBehavior);

        IntersectionBehavior intersectionBehavior = new IntersectionBehavior(this, tgCyl, tgCone, tgSphere, this.curseur, this.curseurKeyListener);
        racine.addChild(intersectionBehavior);
    ...
    public void setAppearance(int index, int bitDeCapacite) {
        /*
        0 : cone
        1 : sphere
        2 : cylindre
        */
        shapes.get(index).getAppearance().getPolygonAttributes().setPolygonMode(bitDeCapacite);
    }
